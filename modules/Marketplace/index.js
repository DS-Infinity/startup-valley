    ...
    <div className={styles.card}>
      ...
      <div className={styles.card__content}>
        ...
        <div className={styles.card__content__buttons}>
          <PrimaryButton
            style={{ background: '#A1A34E' }}
            onClick={() => {
              setShowStats(showStats + 1);
            }}
          >
            stats
          </PrimaryButton>
          <StatsPopup openState={showStats} slave={slave} />
          <PrimaryButton
            onClick={() => {
              hire(slave);
            }}
      ...
      <div className={styles.cardpower__content}>
        <div className={styles.imagestuff}>
          <div className={styles.imgContainer2}>
            <Image
              src={image}
              width={imwidth ? imwidth : 120}
              style={imstyle}
              height={imheight ? imheight : 120}
            />
          </div>
          <div>
            <div className={styles.card__content__name}>{name}</div>
            <div className={styles.card__content__content}>{content}</div>
            <div
              className={styles.card__content__stats}
      ...
      <div className={styles.main}>
        ...
        <div className={styles.main__content}>
          <PowerupCard
            ...
            name={'Stackoverflow Snips'}
            faction={'dev'}
            price={'200'}
            content={
              "the developer instantly ctrl + c and ctrl + v's stackoverflow code"
            }
          ></PowerupCard>
          <PowerupCard
            image={'/npm.png'}
            imstyle={{ marginLeft: '16px' }}
            imwidth={90}
            imheight={120}
            name={'NPM Package'}
            faction={'dev'}
            price={'100'}
            content={
              'the developer finds a npm package to do just what the startup needs'
            }
          ></PowerupCard>
          <PowerupCard
            image={'/behance.png'}
            imstyle={{ marginLeft: '0px' }}
            imwidth={90}
            imheight={90}
            name={'Behance "Inspiration"'}
            faction={'design'}
            price={'300'}
            content={
              'the designer finds a design just like what he was tasked to :wink:'
            }
          ></PowerupCard>
          <PowerupCard
            image={'/image.png'}
            ...
            imwidth={110}
            imheight={120}
            name={'Royalty Free Assets'}
            faction={'design'}
            price={'300'}
            content={
              'the designer finds some free assets which he he can use without credit'
            }
          ></PowerupCard>
          <PowerupCard
            image={'/tiktok.png'}
            ...
            price={'300'}
            content={
              "the marketer's tiktok dance while shilling the app goes trending"
            }
          ></PowerupCard>
          <PowerupCard
            image={'/twitter.png'}
            ...
            price={'300'}
            content={
              'elon musk just tweets about the app this comes in marketing right?'
            }
          ></PowerupCard>
        </div>
      </div>
